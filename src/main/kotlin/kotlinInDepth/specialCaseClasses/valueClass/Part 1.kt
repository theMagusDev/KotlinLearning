package kotlinInDepth.specialCaseClasses.valueClass

// Old name: inline class
...
/* Java bytecode:
 ...
 public final class OverheadDollar {
    ...
    // constructor
    public OverheadDollar(double amount) {
       this.amount = amount;
    }
 }
 ...
...
To solve such issues, Kotlin has introduced a value class.
*/

@JvmInline
value class Dollar(val amount: Double)
@JvmInline
value class Euro(val amount: Double)
fun Dollar.toEuro() = amount * 1.07
fun Euro.toDollar() = amount * 0.94

/* Java:
public static final double toEuro(double $this$toEuro) {
      return $this$toEuro * 1.07;
   }

public static final double toDollar(double $this$toDollar) {
...
/*
 public static final void program1() {
     double result = toEuro(Dollar.constructor-impl(3.35));
     System.out.println(result);
 }
*/

/*
Value (Inline) classes may have their own properties and functions.
Value class properties, however, may not have any state.
