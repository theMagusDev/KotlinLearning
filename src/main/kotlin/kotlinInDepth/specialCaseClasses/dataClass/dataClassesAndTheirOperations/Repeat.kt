...
7) Сначала он проверяет равны ли ссылки объектов. Если да, то смысла проверять дальше нет.
Если нет, он проверяет, является ли сравниваемый объект и исходный instance'ом одного класса.
Если да, то сравнивает их properties попарно.
