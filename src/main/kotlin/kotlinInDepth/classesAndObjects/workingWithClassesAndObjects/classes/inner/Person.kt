package kotlinInDepth.classesAndObjects.workingWithClassesAndObjects.classes.inner

// Note: Inner nested classes object is bound to outer classes object

class Person (name: String, surname: String, age: Int) {
    val information: kotlinInDepth.classesAndObjects.workingWithClassesAndObjects.classes.inner.Person.Information = this.Information(name, surname, age)
...
fun program1() {
    val person = kotlinInDepth.classesAndObjects.workingWithClassesAndObjects.classes.inner.Person("John", "Doe", 25)
...
fun program2() {
    ...
    val person2 = kotlinInDepth.classesAndObjects.workingWithClassesAndObjects.classes.inner.Person2("John", "Doe", 25)
...
fun main() {
    kotlinInDepth.classesAndObjects.workingWithClassesAndObjects.classes.inner.program1()
    kotlinInDepth.classesAndObjects.workingWithClassesAndObjects.classes.inner.program2()
}